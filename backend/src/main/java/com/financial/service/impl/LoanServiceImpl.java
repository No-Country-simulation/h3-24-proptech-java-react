...
public class LoanServiceImpl implements ILoanService {
    ...
    public ResponseLoanDTO createLoan(UUID userId, RequestLoanSimulationDTO request) {
        ...
        Loan loan = Loan.builder()
                ...
                .monthlyQuota(request.monthlyQuota())       // Asignar la cuota mensual del préstamo desde el DTO
                .termMonths(request.termMonths())           // Asignar el término del préstamo desde el DTO
                .interestRate(request.interestRate())       // Asignar la tasa de interés del préstamo desde el DTO
                .totalAmount(request.totalAmount())         // Monto total del préstamo
                .build();
